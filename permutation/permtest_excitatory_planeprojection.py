...
# permutation test - Figure 3j wS1 glutamatergic presynaptic neurons 
...
if __name__ == '__main__':
    ...
    metric_list = []
    for (idx, layer) in enumerate(excit_class):
        metric = []
        for b in tqdm(range(rlen)):
            rg1 = resample_list[b][0]
            rg2 = resample_list[b][1]
            wass = compute_metric(merge_df, rg1, rg2, [layer], metric='wass', center_shift=True)
